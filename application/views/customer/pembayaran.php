                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tr class="text-success">
                            ...
                            <td>:</td>
                            <td><button class="btn btn-sm btn-success">Rp. <?php echo number_format($tr->harga * $jml,0,',','.') ?></button></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td></td>
            ...
            <div class="card" style="margin-top: 100px">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Bank CIMB NIAGA : 9128491758215</li>
                        <li class="list-group-item">Bank BCA        : 0581285812</li>
                        <li class="list-group-item">Bank MANDIRI    : 08501280582</li>
                    </ul>
